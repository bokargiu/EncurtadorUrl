...
- Crie um projeto angular com ng: `ng new encurtador_url.client --defaults --skip-install --skip-git --no-standalone `.
...
- Criar o arquivo de projeto (`encurtador_url.client.esproj`).
